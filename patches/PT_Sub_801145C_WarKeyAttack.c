// @Description PT_Sub_801145C_WarKeyAttack
...
int PT_Sub_801145C_WarKeyAttack()
{
	...
	else
	{
		...
		else if (usTrg_KeyPress1Frame[0] & KEY_DOWN)
		{
			// Increase X speed before start rolling
			...
			result = ROLL; // Change to ROLL (not SSLIP)
		}
