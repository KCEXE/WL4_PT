// @Description PT_Sub_8013894_State0GmWarioMove
...
int PT_Sub_8013894_State0GmWarioMove()
{
	int v0;
	int v1;
	int v3;
	...
	{
	case WALK:
		dashAttackFlag = 0; // Not super-dashing
		break;
	case DATTACK:
	case ROLL:
		dashAttackFlag = 1; // Yes super-dashing
		break;
	case JUMP:
	case SJUMP:
	case RJUMP:
	...
	else
	{
		...
		if (!Wario_ucStat || Wario_ucStat == ATTACK)
		{
